...
//        }
    ...
    private fun setUpNav() {
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.nav_home, R.id.nav_mess_leave, R.id.nav_messCommitteeActivity, R.id.nav_admin, R.id.nav_slideshow
            ), drawerLayout
        )
    ...
    private fun setUpHeader() {
        ...
        try {
            ...
            layout.findViewById<TextView>(R.id.mname).text = if (user.name.isNotEmpty()) user.name else "Guest User"
            layout.findViewById<TextView>(R.id.email).text = if (user.email.isNotEmpty()) user.email else auth.currentUser?.email ?: "No email"
        } catch (e: Exception) {
